...
## 质量门禁（改完必跑）
```
npm run typecheck && npm run build      # 类型 + 静态预渲染（现 248 页：8 计算器 base + 52 预设 × 4 语言）
...
当前 8 个计算器：schengen / fire / tdee / compound / mortgage / body-fat-bmi / auto-loan / student-loan（finance 类 5 个）。
